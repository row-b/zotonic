...
recombine_date_part({{_Y, M, D}, {H, I, S}}, <<"y">>, V) ->
    {{V, M, D}, {H, I, S}};
recombine_date_part({{Y, _M, D}, {H, I, S}}, <<"m">>, V) ->
    {{Y, V, D}, {H, I, S}};
recombine_date_part({{Y, M, _D}, {H, I, S}}, <<"d">>, V) ->
    {{Y, M, V}, {H, I, S}};
recombine_date_part({{Y, M, D}, {_H, I, S}}, <<"h">>, V) ->
    {{Y, M, D}, {V, I, S}};
recombine_date_part({{Y, M, D}, {H, _I, S}}, <<"i">>, V) ->
    {{Y, M, D}, {H, V, S}};
recombine_date_part({{Y, M, D}, {H, I, _S}}, <<"s">>, V) ->
    {{Y, M, D}, {H, I, V}};
recombine_date_part({{Y, M, D}, {_H, _I, S}}, <<"hi">>, {H, I, _S}) ->
    {{Y, M, D}, {H, I, S}};
recombine_date_part({{Y, M, D}, _Time}, <<"his">>, {_, _, _} = V) ->
    {{Y, M, D}, V};
recombine_date_part({_Date, {H, I, S}}, <<"ymd">>, {_, _, _} = V) ->
    {V, {H, I, S}}.
