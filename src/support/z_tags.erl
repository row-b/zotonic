...
%% @doc Render a tag with properties, return the tag text. div has special
%% handling as <div/> is not allowed.
...
optional_escape_property({<<"src">>, Uri}) -> {<<"src">>, optional_escape(Uri)};
optional_escape_property({<<"href">>, Uri}) ->
    {<<"href">>, optional_escape(Uri)};
