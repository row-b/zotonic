...
parse_email({<<"message">>, <<"rfc822">>}, _Headers, _Params, Body) ->
    ...
    Html = iolist_to_binary(
        [
            ...
            <<"<dt>From:</dt><dd>">>,
            z_html:escape(proplists:get_value(<<"From">>, FwdHeaders, <<>>)),
            <<"</dd>">>,
            <<"<dt>To:</dt><dd>">>,
            z_html:escape(proplists:get_value(<<"To">>, FwdHeaders, <<>>)),
            <<"</dd>">>,
            case Cc of
                undefined -> <<>>;
            ...
            <<"<dt>Subject:</dt><dd>">>,
            z_html:escape(proplists:get_value(<<"Subject">>, FwdHeaders, <<>>)),
            <<"</dd>">>,
            <<"<dt>Date:</dt><dd>">>,
            z_html:escape(proplists:get_value(<<"Date">>, FwdHeaders, <<>>)),
            <<"</dd>">>,
            <<"</dl>">>
        ]),
